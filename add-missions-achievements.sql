...
ALTER TABLE missions ADD COLUMN IF NOT EXISTS target_value INTEGER DEFAULT 1;
...
-- 6. 미션 데이터 삽입
INSERT INTO missions (key, title, description, target, target_value, reward_gold, active, mission_type) VALUES
('enhance_success', '강화 성공', '검을 1회 강화 성공하세요', 1, 1, 1000, true, 'daily'),
('enhance_10', '강화 10회', '검을 10회 강화 성공하세요', 10, 10, 10000, true, 'weekly'),
('enhance_50', '강화 50회', '검을 50회 강화 성공하세요', 50, 50, 50000, true, 'achievement'),
('enhance_100', '강화 100회', '검을 100회 강화 성공하세요', 100, 100, 100000, true, 'achievement'),
('defeat_dummy', '허수아비 격파', '허수아비를 1회 격파하세요', 1, 1, 500, true, 'daily'),
('defeat_dummy_10', '허수아비 10회 격파', '허수아비를 10회 격파하세요', 10, 10, 5000, true, 'weekly'),
('defeat_dummy_50', '허수아비 50회 격파', '허수아비를 50회 격파하세요', 50, 50, 25000, true, 'achievement'),
('pvp_win', 'PvP 승리', 'PvP에서 1회 승리하세요', 1, 1, 2000, true, 'daily'),
('pvp_win_10', 'PvP 10회 승리', 'PvP에서 10회 승리하세요', 10, 10, 20000, true, 'weekly')
...
-- 7. 업적 데이터 삽입
INSERT INTO achievements (key, title, description, target, target_value, active) VALUES
('enhance_success', '첫 강화', '검을 처음으로 강화하세요', 1, 1, true),
('enhance_10', '강화 마스터', '검을 10강까지 강화하세요', 1, 1, true),
('enhance_15', '강화 전문가', '검을 15강까지 강화하세요', 1, 1, true),
('enhance_20', '강화 신', '검을 20강까지 강화하세요', 1, 1, true),
('defeat_dummy', '전투 입문', '첫 허수아비를 격파하세요', 1, 1, true),
('defeat_dummy_10', '전투 숙련자', '허수아비를 10회 격파하세요', 10, 10, true),
('defeat_dummy_50', '전투 마스터', '허수아비를 50회 격파하세요', 50, 50, true),
('defeat_dummy_100', '전투의 신', '허수아비를 100회 격파하세요', 100, 100, true),
('pvp_win', 'PvP 입문', 'PvP에서 첫 승리를 거두세요', 1, 1, true),
('pvp_win_10', 'PvP 숙련자', 'PvP에서 10회 승리하세요', 10, 10, true),
('pvp_win_50', 'PvP 마스터', 'PvP에서 50회 승리하세요', 50, 50, true),
('hidden_sword', '히든 검 수집가', '히든 검을 획득하세요', 1, 1, true),
('collection_10', '검 수집가', '10개의 검을 수집하세요', 10, 10, true),
('collection_50', '검 컬렉터', '50개의 검을 수집하세요', 50, 50, true),
('collection_100', '검 마스터', '100개의 검을 수집하세요', 100, 100, true)
ON CONFLICT (key) DO UPDATE SET
    title = EXCLUDED.title,
    description = EXCLUDED.description,
    target = EXCLUDED.target,
