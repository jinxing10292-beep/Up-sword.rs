...
-- user_achievement_milestones 테이블 RLS
...
-- Supabase Dashboard > Storage에서 수동으로 생성하거나 아래 명령 실행
-- INSERT INTO storage.buckets (id, name, public) VALUES ('codet-img', 'codet-img', true);
